...
namespace InsurancePlatform.ContractingService.Api.Middlewares;
...
public sealed class ExceptionHandlerMiddleware
{
    ...
    private static int GetStatusCode(Exception exception)
    {
        return exception switch
        {
            ...
            ProposalNotApprovedException => StatusCodes.Status422UnprocessableEntity,
            ProposalAlreadyContractedException => StatusCodes.Status409Conflict,
